...
//       <div
//         className={`mb-3 flex items-center gap-2 rounded-md border px-2.5 py-2 transition ${
//           classification
//             ? "border-base-border bg-base-panel2"
//             : "border-dashed border-base-border bg-transparent"
//         }`}
//       >
//         <Icon
//           size={14}
//           className={`shrink-0 ${classification ? "text-amber" : "text-text-tertiary"}`}
//         />
//         <div className="min-w-0">
//           <p className="truncate text-xs font-medium text-text-primary">
...
//               : "3 models resident · ready to route"}
//           </p>
//         </div>
//       </div>
...
export default function ModelRouter({ classification }) {
  ...
  return (
    <div className="rounded-xl border border-base-border bg-base-panel p-3.5 shadow-panel">
      ...
      >
        <Icon size={14} className={`shrink-0 ${classification ? "text-amber" : "text-text-tertiary"}`} />
        <div className="min-w-0">
          <p className="truncate text-xs font-medium text-text-primary">
            {classification ? classification.task : "Standing by"}
          </p>
          ...
          return (
            <div
              ...
              className={`flex items-center justify-between rounded-md px-2 py-1.5 text-xs transition-colors duration-200 ${
                isActive ? "border border-amber/40 bg-amber/10 text-text-primary" : "border border-transparent text-text-secondary"
              }`}
            >
              <span>{m.label}</span>
